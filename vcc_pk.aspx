	...
	<head>
		...
		<script type="text/javascript">
			...
			var bbsNum = [
				...
				['textSize4', 10, 2, 1], ['txtTranmoney', 10, 2, 1]
			];
			var bbmMask = [];
			var bbsMask = [];
			q_sqlCount = 6;
				...
				switch (b_pop) {
					case 'view_vcce_import':
						if (q_cur > 0 && q_cur < 4) {
							...
							AddRet = q_gridAddRow(bbsHtm, 'tbbs', 'txtUno,txtOrdeno,txtNo2,txtProductno,txtProduct,txtRadius,txtWidth,txtDime,txtLengthb,txtSpec,txtTranmoney,txtMount,txtWeight,txtPrice,txtStyle,txtSize'
							, b_ret.length, b_ret, 'uno,ordeno,no2,productno,product,radius,width,dime,lengthb,spec,mount,weight,mount,price,style,size', '');
				...
				switch (t_name) {
					...
					case 'view_vccs':
						...
						if (vcces_as[0] != undefined) {
							...
							AddRet = q_gridAddRow(bbsHtm, 'tbbs', 'txtUno,txtProductno,txtProduct,txtSpec,txtRadius,txtDime,txtWidth,txtLengthb,txtMount,txtWeight,txtTranmoney,txtPrice,txtStyle,txtOrdeno,txtNo2,txtSize', vcces_as.length, vcces_as
							, 'uno,productno,product,spec,radius,dime,width,lengthb,mount,weight,mount,price,style,ordeno,no2,size', 'txtUno');
							size_change();
							sum();
							//get ordes.price <Start>
							var distinctArray = new Array;
