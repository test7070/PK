		...
		<script type="text/javascript">
			...
			function getUno(n) {
				if(n<q_bbsCount){
					...
					if($('#txtUno_' + n).val().length == 0 && $('#txtProductno_'+n).val().toUpperCase()!='代工費' && (($('#txtStyle_' + n).val().toUpperCase()>='A' && $('#txtStyle_' + n).val().toUpperCase()<='M') || $('#txtStyle_' + n).val().toUpperCase()=='X')){
