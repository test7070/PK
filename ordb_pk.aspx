	...
	<head>
		...
		<script type="text/javascript">
			...
			function _btnSeek() {
				...
				q_box('ordb_s.aspx', q_name + '_s', "500px", "400px", q_getMsg("popSeek"));
			}
			...
			<div class="dbbm">
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td><span> </span><a id='lblPostname' class="lbl">連絡人</a></td>
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs' style=' text-align:center'>
				<tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:100px;"><a>等級</a><BR><a>鋼廠</a></td>
